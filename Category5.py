...
def solution_model():
    ...
    model = tf.keras.models.Sequential([
        ...
        # since it has not been implemented in the cuDNN kernel and may
        # result in much longer training times.
        tf.keras.layers.Conv1D(filters=32, kernel_size=5, strides=1, padding="causal", activation="relu", input_shape=[None, 7]),
    ...
    optimizer = tf.keras.optimizers.SGD(lr=1.0000e-08, momentum=0.9) # YOUR CODE HERE
    model.compile(
